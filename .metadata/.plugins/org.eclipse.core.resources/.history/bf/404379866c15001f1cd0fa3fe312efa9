...
static void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pins : LOAD_Pin ENA_INVERTER_Pin BCCU_Pin */
    GPIO_InitStruct.Pin = LOAD_Pin | ENA_INVERTER_Pin | BCCU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    /*Configure GPIO pins : LED_INDICATE_Pin FAN_Pin BUCK_ENABLE_Pin ANTI_BACKFLOW_Pin */
    ...
    /*Configure GPIO pins : GPIO2_Pin GPIO15_Pin */
