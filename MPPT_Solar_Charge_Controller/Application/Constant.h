...
static constexpr float k_voltage_divider_output = 15.0f;    // Max battery voltage = 15 -> 15/5 = 3V
...
static const float k_voltage_battery_max = 15.0f;    // 15V
static const float k_voltage_battery_min = 10.0f;
